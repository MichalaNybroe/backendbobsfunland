...
public class BookingRESTController {
    ...
    public List<Booking> searchBookings(@RequestBody String emailOrPhoneInput) {
        return bookingRepository.searchBookingByCustomerEmailOrCustomerPhone(emailOrPhoneInput);
    }
